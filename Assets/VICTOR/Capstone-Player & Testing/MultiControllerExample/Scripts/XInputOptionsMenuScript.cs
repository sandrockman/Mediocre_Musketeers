...
public class XInputOptionsMenuScript : MonoBehaviour {
    ...
    public Button CreditsGameButton;
    [Tooltip("Highlight image for Credits button")]
    public Image CreditsHighlight;
    ...
    void Start()
    {
        ...
        CreditsHighlight.enabled = false;
        #region OldStart
        /*
